...
jQuery.validator.addMethod("price", function(value, element) {   
	var jiage=/^\d+(\.\d{2})?$/;
    return this.optional(element) || (jiage.test(value));
}, "两位小数");
...
jQuery.validator.addMethod("compareDate", function(value, element) {
	var currtime =getDate().substring(0,9);//new Date();
	endDate =value.replace(/-/g,"/");    //new Date(parseInt(Date.parse(value), 10));
...
//		return true;
//	}
}, "<font color='red'>选择时间不能早于今天！</font>");
